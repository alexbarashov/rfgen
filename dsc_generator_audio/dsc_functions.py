...
def transmit_dsc(dsc_call, pwr):
    ...
    wavedata = modulate(bitstream_list, 1700, +400, -400, 44100, 1200.0, pwr)

    # make some noise...

    cpfsk_stream.write(wavedata)

    return

# Save DSC signal to WAV file
def save_dsc_to_wav(dsc_call, pwr, filename="dsc_output.wav", sample_rate=44100):
    ...
    # get a list of sample values from the CPFSK modulator
    wavedata = modulate(bitstream_list, 1700, +400, -400, sample_rate, 1200.0, pwr)
